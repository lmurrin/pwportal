      ...
      <form onSubmit={onSubmit}>
        <div className="space-y-12">
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
            ...
            <div className="mb-30 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
        ...
        <div className="fixed bottom-0 left-0 right-0 border-t border-gray-200 bg-gray-100 px-12 py-4 flex items-center justify-end gap-x-6 shadow-md">
          <button
            type="button"
            onClick={hideOverlay}
